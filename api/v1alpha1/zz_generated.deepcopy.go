...
func (in *SyncConfigCondition) DeepCopy() *SyncConfigCondition {
	...
	out := new(SyncConfigCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in SyncConfigConditionMap) DeepCopyInto(out *SyncConfigConditionMap) {
	{
		in := &in
		*out = make(SyncConfigConditionMap, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncConfigConditionMap.
func (in SyncConfigConditionMap) DeepCopy() SyncConfigConditionMap {
	if in == nil {
		return nil
	}
	out := new(SyncConfigConditionMap)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *SyncConfigStatus) DeepCopyInto(out *SyncConfigStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]SyncConfigCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
